...
class TestDequeQueue(unittest.TestCase):
    ...
    def test_enqueue(self):
        ...
        s = DequeQueue()
        self.assertEqual(0, len(s))
        self.assertEqual(5, s._array.maxlen)
        ...
        s.enqueue(6)
        self.assertEqual(6, len(s))
        self.assertEqual(10, s._array.maxlen)
        self.assertEqual(1, s.first())
        self.assertEqual(1, s._array[5])

        # add another object
        s.enqueue(QueueEmptyException)
        self.assertEqual(7, len(s))
        self.assertEqual(7, len(s._array))
        self.assertEqual(QueueEmptyException, s._array[0])

        self.assertEqual(1, s.first())

        # remove front and check new first
        self.assertEqual(1, s.dequeue())
        self.assertEqual(2, s.first())
